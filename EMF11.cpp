...
void DrawRuler11(HDC hdc, int cx, int cy)
{
	int i, iHeight;
	LOGFONT lf;
	TCHAR ch;
...
void CreateRoutine11(HWND hwnd)
{
	HDC hdcEMF;
	HENHMETAFILE hemf;
	...
	DrawRuler11(hdcEMF, 600, 100);
	hemf = CloseEnhMetaFile(hdcEMF);
	DeleteEnhMetaFile(hemf);
}
void PaintRoutine11(HWND hwnd, HDC hdc, int cxArea, int cyArea)
{
	ENHMETAHEADER emh;
	HENHMETAFILE hemf;
